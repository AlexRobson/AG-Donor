...
function laecho_fs_widget_add(){
        $laecho_widget_to_add = LAECHO_FOLLOW_SUBSCRIBE_ID;
...
function laecho_wp_admin_options_settings () {
	...
	$networkpub_forms_others = array('laechonw_enable_form', 'laechonw_auth_error_show_form', 'laechonw_post_types_form');
	...
	global $laechonw_auth_error_show, $laechonw_mixed_mode_alert_show, $laechonw_enable;
