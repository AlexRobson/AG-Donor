<div class="wrap">
	...
	?>
		...
		<table cellspacing="5" cellpadding="5" class="widefat" width="400">
			...
			<tr>
			<td><?php _e('Social Icon Mouse Hover Background Animation: ','WPSOCIALTOOLBAR'); ?></td>
			<td>
			<select name="SOCIALTOOLBAROPTIONS[hover_animation]" class="social_basic" style="width:120px;">
			<option value="false"><?php _e('No','WPSOCIALTOOLBAR'); ?></option>
			<option value="false"><?php _e('Yes','WPSOCIALTOOLBAR'); ?></option>			
			</select> <span style="color:#666;"><small><?php _e('Enable Background hover animation. ','WPSOCIALTOOLBAR'); ?></small><small class="wpst_pro_only"><?php echo DDST_PRO_ONLY_TEXT; ?></small></span>
			</td>
			</tr>
